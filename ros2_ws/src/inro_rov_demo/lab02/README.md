# Laboratory 2 — BlueROV2 depth mission

## Objective

After [Laboratory 1](../lab01/README.md), write a feedback controller for a
standard BlueROV2. The vehicle
...
```bash
python3 src/inro_rov_demo/lab02/student_depth_mission.py
```
...
```bash
ros2 run inro_rov_demo lab2_reference_mission
```
